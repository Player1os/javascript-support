// Load local modules.
const format = require('.../lib/common/format')
...
const spawnChildProcessAsync = (
	...
	return new Promise((resolve, reject) => {
		...
		const childProcess = spawnChildProcess(command, processArguments, {
			shell: true,
			stdio,
		})
...
exports.inherited = async (
	...
	return spawnChildProcessAsync(taskName, command, processArguments, 'inherit', isResultVerificationSuppressed)
}
...
exports.piped = async (
	...
	return spawnChildProcessAsync(taskName, command, processArguments, 'pipe', isResultVerificationSuppressed)
}
